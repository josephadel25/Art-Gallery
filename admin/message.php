  ...
  <body>
    ...
    <section id="title" class="position-relative py-3 py-lg-7 overflow-hidden " style="padding: 12% 0 5% 0;text-align: center;">
        <div class="title  pt-6" >
          <h1 class="hero-heading mb-0" style="color: #000000;">Message</h1>
        </div>
    </section>
...
$conn = $database->getConnection();
                    $result1 = mysqli_query($conn, "SELECT * FROM message");
                    $i = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method='post' action='../classes/delete.php'>
                                        <button type='submit' name='msg' value='$row[id]' class='btn btn-md btn-outline-danger'>Delete</button>
                                    </form>
                                </td>
                            </tr>";
                        $i += 1;
