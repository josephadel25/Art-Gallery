        ...
        <div class="container-fluid">
          <div class="d-flex align-items-center row">
            <div class="d-none d-sm-block col-sm-7">
              <ul class="list-inline mb-0 topbar-text">
                <li class="list-inline-item pe-3 me-0">020-800-456-747</li>
                <li class="list-inline-item px-3 border-start d-none d-lg-inline-block">Free shipping on orders over $2000</li>
              </ul>
            </div>
            <div class="d-flex justify-content-end col-sm-5">
            <form method="post"  action="classes/become.php">
            <div class="border-end px-3">
                <button class="topbar-link" type="submit" id="langsDropdown" aria-expanded="false" style="background-color:#F8F9FA;border:none;">Become an Artist</button>
                </div>
            </form>
