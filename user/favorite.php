...
$conn = $database->getConnection();
    ...
    <section id="title" class="position-relative py-3 py-lg-7 overflow-hidden" style="padding: 12% 0 5% 0;text-align: center;">
      <ul class="breadcrumb justify-content-center no-border mb-0">
        ...
        <li class="breadcrumb-item text-black active">favorite</li>
      </ul>
        <div class="title" >
          <h1 class="hero-heading mb-0" style="color: #000000;">YOUR FAVOURITES</h1>
        </div>
    </section>
    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                $query = "SELECT artworks.*, users.name AS artist_name 
                          FROM artworks 
                          JOIN favorite ON artworks.id = favorite.artid 
