        ...
        <div class="container-fluid">  
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
              ...
              <div class="nav-item"><a class="navbar-icon-link" href="gift.php"> 
              ...
              <div class="nav-item"><a class="navbar-icon-link" href="favorite.php"> 
              ...
              <!-- Cart -->
              <div class="nav-item"><a class="navbar-icon-link" href="cart.php"> 
