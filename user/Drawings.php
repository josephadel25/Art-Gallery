...
<html lang="en" data-bs-theme="auto">
  ...
  <header class="header header-absolute">
    ...
    <section class="position-relative dark-overlay py-3 py-lg-7 overflow-hidden"  style="background: url(../img/pexels-antoni-shkraba-4442028.jpg) no-repeat center center fixed; background-size: cover;"  data-parallax="scroll" data-speed="0.3" data-position-x="right">
      <div class="container overlay-content hero hero-page">
        <ul class="breadcrumb justify-content-center no-border mb-0">
          <li class="breadcrumb-item"><a class="text-white" href="../index.php">Home</a></li>
          <li class="breadcrumb-item text-white active">Drawings</li>
        </ul>
        <div class="hero-content pb-5 text-center text-white">
          <h1 class="hero-heading">Drawings</h1><p class="lead">Choose from a wide-ranging selection of 74,622 original drawings and prints ranging in subject, style and media from figurative to abstract, monochromatic to multicoloured, and charcoal to pencil.</p>                        
        </div>
      </div>
    </section>
    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                $result = mysqli_query($conn, "SELECT artworks.*, users.name as name FROM artworks LEFT JOIN users ON artworks.artistid = users.id WHERE artworks.category LIKE 4");
