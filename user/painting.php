...
$conn = $database->getConnection();
  ...
  <section class="position-relative dark-overlay py-3 py-lg-7 overflow-hidden"  style="background: url(../img/pexels-daian-gan-102127.jpg) no-repeat center center fixed; background-size: cover;"  data-parallax="scroll" data-speed="0.3" data-position-x="right">
    <div class="container overlay-content hero hero-page">
      <ul class="breadcrumb justify-content-center no-border mb-0">
        <li class="breadcrumb-item"><a class="text-white" href="../index.php">Home</a></li>
        <li class="breadcrumb-item text-white active">Paintings</li>
      </ul>
      <div class="hero-content pb-5 text-center text-white">
        <h1 class="hero-heading">Paintings</h1><p class="lead">Whether you are looking for an original painting or a high quality art print, Saatchi Art has over 677,583 original paintings for sale from emerging artists around the world.</p>                        
      </div>
    </div>
  </section>
    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                $result = mysqli_query($conn, "SELECT artworks.*, users.name as name FROM artworks LEFT JOIN users ON artworks.artistid = users.id WHERE artworks.category LIKE 2");
