...
$conn = $database->getConnection();
  ...
  <section id="title" class="position-relative py-3 py-lg-7 overflow-hidden" style="padding: 12% 0 5% 0;text-align: center;">
    <ul class="breadcrumb justify-content-center no-border mb-0">
      ...
      <li class="breadcrumb-item text-black active">gift</li>
    </ul>
      <div class="title" >
        <h1 class="hero-heading mb-0" style="color: #000000;">Egift Cards</h1>
        <div class="row">   
          <div class="col-xl-8 offset-xl-2" style="text-align: start;"><p class="lead text-muted">Give the gift of art with a Saatchi Art gift card. Select a value, personalize it with your message, and have it emailed to a friend or loved one immediately. It's the perfect present for any special occasion!</p></div>
        </div>
      </div>
  </section>
      ...
      <div class="row justify-content-center">
        <div class="col-md-7 mb-5 mb-md-0">
            <form class="form" id="contact-form" method="post" action="contact.php">
              <div class="controls">
                <div class="mb-4">
                    <input class="form-control" type="text" name="card" id="email" placeholder="Enter amount (USD)" required="required">
                  </div>
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-4">
                      <input class="form-control" type="text" name="name" id="name" placeholder="Enter Recipients firstname" required="required">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="mb-4">
                      <input class="form-control" type="text" name="surname" id="surname" placeholder="Enter Recipients lastname" required="required">
                    </div>
                  </div>
                </div>
                <div class="mb-4">
                  <input class="form-control" type="text" name="card" id="email" placeholder="Enter Recipients email" required="required">
                </div>
                <div class="mb-4">
                  <textarea class="form-control" rows="4" name="message" id="message" placeholder="Enter your message" required="required"></textarea>
                </div>
              </div>
              <label class="form-label" for="name" style="color: #000000; font-weight: 600;">Payment information</label>
              <div class="controls">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-4">
                ...
                <div class="mb-4">
                  <input class="form-control" type="email" name="email" id="email" placeholder="Credit Card Number" required="required">
                </div>
                <div class="row">
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <input class="form-control" type="text" name="name" id="name" placeholder="MM / YY" required="required">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <input class="form-control" type="text" name="surname" id="surname" placeholder="Security Code" required="required">
                      </div>
                    </div>
                  </div>
              </div>
              <label class="form-label" for="name" style="color: #000000; font-weight: 600;">Billing information</label>
              <div class="controls">
                <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <input class="form-control" type="text" name="name" id="name" placeholder="Country" required="required">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <input class="form-control" type="text" name="surname" id="surname" placeholder="State/Region*" required="required">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <input class="form-control" type="text" name="name" id="name" placeholder="City*" required="required">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="mb-4">
                        <input class="form-control" type="text" name="surname" id="surname" placeholder="Zip/Postal Code*" required="required">
                      </div>
                    </div>
                  </div>
              </div>
              <a class="btn btn-outline-dark"  href='gift.php'>Purchase Gift Card</a>
            </form>
          </div>
