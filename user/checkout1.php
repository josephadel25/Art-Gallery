      ...
      <div class="container">
        ...
        <div class="col-lg-8">
            <ul class="custom-nav nav nav-pills mb-5">
              <li class="nav-item w-50"><a class="nav-link text-sm " href="checkout.php">Payment Method </a></li>
              <li class="nav-item w-50"><a class="nav-link text-sm active" href="checkout1.php">Order Review</a></li>
            </ul>
            <div class="mb-5">
              <div class="cart">
            ...
            <div class="mb-5 d-flex justify-content-between flex-column flex-lg-row">
                <a class="btn btn-link text-muted" href="checkout.php"> <i class="fa fa-angle-left me-2"></i>Back to the delivery method</a>
                <form action="../classes/checkout.php" method='post'>
                <button class="btn btn-dark" type='submit'>Place an order<i class="fa fa-angle-right ms-2"></i></button>
                </form>
                </div>
          </div>
