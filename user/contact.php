...
$conn = $database->getConnection();
    ...
    <section id="title" class="position-relative py-3 py-lg-7 overflow-hidden" style="padding: 12% 0 5% 0;text-align: center;">
      <ul class="breadcrumb justify-content-center no-border mb-0">
        ...
        <li class="breadcrumb-item text-black active">contact</li>
      </ul>
        <div class="title" >
          <h1 class="hero-heading mb-0" style="color: #000000;">CONTACT</h1>
        </div>
    </section>
    ...
    <div class="container mb-5">
      <div class="row justify-content-center">
        <div class="col-md-7 mb-5 mb-md-0">
            <form class="form" id="contact-form" method="post" action="../classes/insert.php">
              <div class="controls">
                <div class="mb-4">
                ...
                <button name='contact' class="btn btn-outline-dark" type="submit">Send message</button>
              </div>
            </form>
          </div>
