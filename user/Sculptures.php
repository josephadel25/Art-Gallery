...
$conn = $database->getConnection();
    ...
    <section class="position-relative dark-overlay py-3 py-lg-7 overflow-hidden"  style="background: url(../img/pexels-axel-grollemund-2723450.jpg) no-repeat center center fixed; background-size: cover;"  data-parallax="scroll" data-speed="0.3" data-position-x="right">
      <div class="container overlay-content hero hero-page">
        <ul class="breadcrumb justify-content-center no-border mb-0">
          <li class="breadcrumb-item"><a class="text-white" href="../index.php">Home</a></li>
          <li class="breadcrumb-item text-white active">Sculptures</li>
        </ul>
        <div class="hero-content pb-5 text-center text-white">
          <h1 class="hero-heading">Sculptures</h1><p class="lead">Browse our wide-ranging selection of over 32,952 original sculptures by artists working in a variety of mediums. Suitable for both the interior home and outdoor spaces, sculptures anchor a space and are available in numerous textures and colors.</p>                        
        </div>
      </div>
    </section>
  ...
  <section style="background-color: rgb(255, 255, 255);">
    <section class="container" style="padding: auto;">
      <div class="container" style="padding: 3% 0%;">
        <div class="row gutter-1 align-items-end" >
          <div class="col-md-6">
            <p style="color: #8A9096;">Showing <span style="color: #000;font-weight:600;">1 - 12</span> of <span style="color: #000;font-weight:600;">12 </span>product</p>
          </div>
          <div class="col-md-6 d-flex align-items-center"><span class="d-inline-block me-2">Sort by</span>
    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                $result = mysqli_query($conn, "SELECT artworks.*, users.name as name FROM artworks LEFT JOIN users ON artworks.artistid = users.id WHERE artworks.category LIKE 3");
                              ...
                              <div class='product-hover-overlay'>
                                  ...
                                  <div class='product-hover-overlay-buttons d-flex' >
                                        <form method='GET' action='../classes/insert.php'>
                                          ...
                                          <button name='cart' class='btn btn-outline-dark btn-product-left d-none d-sm-inline-block' type='submit'><i class='fa fa-shopping-cart'></i></button>
                                        </form>
                                        ...
                                        <form method='post' action='../classes/insert.php'>
                                          <input type='hidden' name='value' value=$row[id]>
                                          <button name='fav' class='btn btn-outline-dark btn-product-right d-none d-sm-inline-block' type='submit'><i class='fa-solid fa-heart'></i></button>
